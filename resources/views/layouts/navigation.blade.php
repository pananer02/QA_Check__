        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="{{ route('dashboard') }}" class="flex ms-2 md:me-24">
                    <svg class="w-8 h-8 me-3" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        fill="#f0465b" viewBox="0 0 24 24">
                    ...
                    <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap">QA Check List</span>
                </a>
            </div>
                ...
                <div class="flex items-center ms-3">
                    <div>
                        <button type="button"
                            ...
                            <img class="w-8 h-8 rounded-full" src="{{ asset('public/img/suangkan.jpg') }}" alt="user photo">
                        </button>
                    </div>
